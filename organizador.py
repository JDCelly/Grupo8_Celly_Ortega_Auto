...
No incluyas explicaciones, solo el JSON."""
    ...
    try:
        ...
        return {}
    def mover_archivos(ruta_carpeta: str, clasificacion: dict) -> dict: """Mueve los archivos a subcarpetas según la clasificación de Claude.
...
def main():
    ...
    print("-" * 55)
    estadisticas = mover_archivos(ruta, clasificacion) # type: ignore
...
if __name__ == "__main__":
    ...
    if archivos:
        clasificacion = clasificar_con_claude(archivos)
        print(f"\nClasificación completada: {len(clasificacion)} archivos")